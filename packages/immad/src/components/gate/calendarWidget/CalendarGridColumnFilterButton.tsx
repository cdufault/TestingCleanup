...
import { StyledPopoverBox } from '../../tacticalGrid/styles';
import CaretDownIcon from 'calcite-ui-icons-react/CaretDownIcon';
import { splitButtonOptions } from '../../tacticalGrid/resources';
...
function CalendarGridColumnFilterButton(): JSX.Element {
    const { setColumnState, setFilterState, gridApi, gridColumnApi } = useContext(CalendarFeatureGridContext);
...
export default CalendarGridColumnFilterButton;
